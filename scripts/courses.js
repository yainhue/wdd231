...
function createCards(courses) {
    ...
    courses.forEach((t) => {
        ...
        courseTitle.textContent = `${t.subject} ${t.number}`;
        courseTitle.className = ("course_card");
        if (t.completed == true) {
        ...
        coursesWrapper.appendChild(courseTitle);

        const courseCard = document.querySelector(".course_card")
        courseCard.addEventListener("click", () => {
            displayCourseDetails(t)
        })
